                 ...
                 $.getJSON("../JSON/studienanfanger_bundeslander.json", function(data1){
                    ...
                    case "thuringen":
                     ...
                     // Initialisierung der Variablen und Verwendung vom Index neu
                         ...
                         var a1 = parseFloat(data1.Studienanfaenger_Bundesland[neu1]["Insgesamt"]);
                         var b1 = parseFloat(data1.Studienanfaenger_Bundesland[parseInt(neu1)+parseInt(1)]["Insgesamt"]);
                         var c1 = parseFloat(data1.Studienanfaenger_Bundesland[parseInt(neu1)+parseInt(2)]["Insgesamt"]);
                         var d1 = parseFloat(data1.Studienanfaenger_Bundesland[parseInt(neu1)+parseInt(3)]["Insgesamt"]);
                         var e1 = parseFloat(data1.Studienanfaenger_Bundesland[parseInt(neu1)+parseInt(4)]["Insgesamt"]);
                         var f1 = parseFloat(data1.Studienanfaenger_Bundesland[parseInt(neu1)+parseInt(5)]["Insgesamt"]);
                         var g1 = parseFloat(data1.Studienanfaenger_Bundesland[parseInt(neu1)+parseInt(6)]["Insgesamt"]);
                         var h1 = parseFloat(data1.Studienanfaenger_Bundesland[parseInt(neu1)+parseInt(7)]["Insgesamt"]);
                         var i1 = parseFloat(data1.Studienanfaenger_Bundesland[parseInt(neu1)+parseInt(8)]["Insgesamt"]);
                         var j1 = parseFloat(data1.Studienanfaenger_Bundesland[parseInt(neu1)+parseInt(9)]["Insgesamt"]);
                         var k1 = parseFloat(data1.Studienanfaenger_Bundesland[parseInt(neu1)+parseInt(10)]["Insgesamt"]);
                         var l1 = parseFloat(data1.Studienanfaenger_Bundesland[parseInt(neu1)+parseInt(11)]["Insgesamt"]);
                         var m1 = parseFloat(data1.Studienanfaenger_Bundesland[parseInt(neu1)+parseInt(12)]["Insgesamt"]);
                        ...
                        var erste = parseFloat(data0.baden_wurttemberg[index1]["Insgesamt"]);
                         ...
                         // Daten der LineChart werden aktualisiert: Umrechnung in Prozent und in den 1. Datensatz geladen 
                            myLineChart.datasets[0].points[0].value = parseFloat(((erste * 100) / a1)).toFixed(2);
                    // console.log(myLineChart.datasets[0].points[0].value);
                            myLineChart.datasets[0].points[1].value = parseFloat(((zweite * 100) / b1)).toFixed(2);
                            myLineChart.datasets[0].points[2].value = parseFloat(((dritte * 100) / c1)).toFixed(2);
                            myLineChart.datasets[0].points[3].value = parseFloat(((vierte * 100) / d1)).toFixed(2);
                            myLineChart.datasets[0].points[4].value = parseFloat(((funfte * 100) / e1)).toFixed(2);
                            myLineChart.datasets[0].points[5].value = parseFloat(((sechste * 100) / f1)).toFixed(2);
                            myLineChart.datasets[0].points[6].value = parseFloat(((siebte * 100) / g1)).toFixed(2);
                            myLineChart.datasets[0].points[7].value = parseFloat(((achte * 100) / h1)).toFixed(2);
                            myLineChart.datasets[0].points[8].value = parseFloat(((neunte * 100) / i1)).toFixed(2);
                            myLineChart.datasets[0].points[9].value = parseFloat(((zehnte * 100) / j1)).toFixed(2);
                            myLineChart.datasets[0].points[10].value = parseFloat(((elfte * 100) / k1)).toFixed(2);
                            myLineChart.datasets[0].points[11].value = parseFloat(((zwolfte * 100) / l1)).toFixed(2);
                            myLineChart.datasets[0].points[12].value = parseFloat(((dreizehnte * 100) / m1)).toFixed(2);
                            myLineChart.datasets[0].points[13].value = parseFloat(((vierzehnte * 100) / n1)).toFixed(2);
                            myLineChart.datasets[0].points[14].value = parseFloat(((funfzehnte * 100) / o1)).toFixed(2);
                            myLineChart.datasets[0].points[15].value = parseFloat(((sechzehnte * 100) / p1)).toFixed(2);
                     ...
                     //Switch für das zweite BundesLand
                        ...
                        switch(jslang1){ 
                         case "baden_wurttemberg":
                            ...
                            var ws4 = parseFloat(data2.baden_wurttemberg[parseInt(index1)+parseInt(21)]["Insgesamt"]); 
                            var ws5 = parseFloat(data2.baden_wurttemberg[parseInt(index1)+parseInt(28)]["Insgesamt"]);
                            var ws6 = parseFloat(data2.baden_wurttemberg[parseInt(index1)+parseInt(35)]["Insgesamt"]);
                            var ws7 = parseFloat(data2.baden_wurttemberg[parseInt(index1)+parseInt(42)]["Insgesamt"]); 
                            var ws8 = parseFloat(data2.baden_wurttemberg[parseInt(index1)+parseInt(49)]["Insgesamt"]); 
                            var ws9 = parseFloat(data2.baden_wurttemberg[parseInt(index1)+parseInt(56)]["Insgesamt"]); 
                            var ws10 = parseFloat(data2.baden_wurttemberg[parseInt(index1)+parseInt(63)]["Insgesamt"]); 
                            var ws11 = parseFloat(data2.baden_wurttemberg[parseInt(index1)+parseInt(70)]["Insgesamt"]); 
                            var ws12 = parseFloat(data2.baden_wurttemberg[parseInt(index1)+parseInt(77)]["Insgesamt"]); 
                            var ws13 = parseFloat(data2.baden_wurttemberg[parseInt(index1)+parseInt(84)]["Insgesamt"]); 
                            var ws14 = parseFloat(data2.baden_wurttemberg[parseInt(index1)+parseInt(91)]["Insgesamt"]); 
                            var ws15 = parseFloat(data2.baden_wurttemberg[parseInt(index1)+parseInt(98)]["Insgesamt"]); 
                            var ws16 = parseFloat(data2.baden_wurttemberg[parseInt(index1)+parseInt(105)]["Insgesamt"]);
                         ...
                         case "niedersachsen":
                            ...
                            var ws4 = parseFloat(data2.niedersachsen[parseInt(index1)+parseInt(21)]["Insgesamt"]).toFixed(2); 
                            var ws5 = parseFloat(data2.niedersachsen[parseInt(index1)+parseInt(28)]["Insgesamt"]).toFixed(2);
                            var ws6 = parseFloat(data2.niedersachsen[parseInt(index1)+parseInt(35)]["Insgesamt"]).toFixed(2);
                            var ws7 = parseFloat(data2.niedersachsen[parseInt(index1)+parseInt(42)]["Insgesamt"]).toFixed(2); 
                            var ws8 = parseFloat(data2.niedersachsen[parseInt(index1)+parseInt(49)]["Insgesamt"]).toFixed(2); 
                            var ws9 = parseFloat(data2.niedersachsen[parseInt(index1)+parseInt(56)]["Insgesamt"]).toFixed(2); 
                            var ws10 = parseFloat(data2.niedersachsen[parseInt(index1)+parseInt(63)]["Insgesamt"]).toFixed(2); 
                            var ws11 = parseFloat(data2.niedersachsen[parseInt(index1)+parseInt(70)]["Insgesamt"]).toFixed(2); 
                            var ws12 = parseFloat(data2.niedersachsen[parseInt(index1)+parseInt(77)]["Insgesamt"]).toFixed(2); 
                            var ws13 = parseFloat(data2.niedersachsen[parseInt(index1)+parseInt(84)]["Insgesamt"]).toFixed(2); 
                            var ws14 = parseFloat(data2.niedersachsen[parseInt(index1)+parseInt(91)]["Insgesamt"]).toFixed(2); 
                            var ws15 = parseFloat(data2.niedersachsen[parseInt(index1)+parseInt(98)]["Insgesamt"]).toFixed(2); 
                            var ws16 = parseFloat(data2.niedersachsen[parseInt(index1)+parseInt(105)]["Insgesamt"]).toFixed(2);
                                // Daten der LineChart werden aktualisiert: Umrechnung in Prozent und in den 2. Datensatz geladen 
                                myLineChart.datasets[1].points[0].value = parseFloat(((ws1 * 100) / a)).toFixed(2);
                                myLineChart.datasets[1].points[1].value = parseFloat(((ws2 * 100) / b)).toFixed(2);
                                myLineChart.datasets[1].points[2].value = parseFloat(((ws3 * 100) / c)).toFixed(2);
                         ...
                         case "nordrhein_westfalen":
                            ...
                            var ws4 = parseFloat(data2.nordrhein_westfalen[parseInt(index1)+parseInt(21)]["Insgesamt"]).toFixed(2); 
                            var ws5 = parseFloat(data2.nordrhein_westfalen[parseInt(index1)+parseInt(28)]["Insgesamt"]).toFixed(2);
                            var ws6 = parseFloat(data2.nordrhein_westfalen[parseInt(index1)+parseInt(35)]["Insgesamt"]).toFixed(2);
                            var ws7 = parseFloat(data2.nordrhein_westfalen[parseInt(index1)+parseInt(42)]["Insgesamt"]).toFixed(2); 
                            var ws8 = parseFloat(data2.nordrhein_westfalen[parseInt(index1)+parseInt(49)]["Insgesamt"]).toFixed(2); 
                            var ws9 = parseFloat(data2.nordrhein_westfalen[parseInt(index1)+parseInt(56)]["Insgesamt"]).toFixed(2); 
                            var ws10 = parseFloat(data2.nordrhein_westfalen[parseInt(index1)+parseInt(63)]["Insgesamt"]).toFixed(2); 
                            var ws11 = parseFloat(data2.nordrhein_westfalen[parseInt(index1)+parseInt(70)]["Insgesamt"]).toFixed(2); 
                            var ws12 = parseFloat(data2.nordrhein_westfalen[parseInt(index1)+parseInt(77)]["Insgesamt"]).toFixed(2); 
                            var ws13 = parseFloat(data2.nordrhein_westfalen[parseInt(index1)+parseInt(84)]["Insgesamt"]).toFixed(2); 
                            var ws14 = parseFloat(data2.nordrhein_westfalen[parseInt(index1)+parseInt(91)]["Insgesamt"]).toFixed(2); 
                            var ws15 = parseFloat(data2.nordrhein_westfalen[parseInt(index1)+parseInt(98)]["Insgesamt"]).toFixed(2); 
                            var ws16 = parseFloat(data2.nordrhein_westfalen[parseInt(index1)+parseInt(105)]["Insgesamt"]).toFixed(2);
                                // Daten der LineChart werden aktualisiert: Umrechnung in Prozent und in den 2. Datensatz geladen 
                                myLineChart.datasets[1].points[0].value = parseFloat(((ws1 * 100) / a)).toFixed(2);
                                myLineChart.datasets[1].points[1].value = parseFloat(((ws2 * 100) / b)).toFixed(2);
                                myLineChart.datasets[1].points[2].value = parseFloat(((ws3 * 100) / c)).toFixed(2);
                         ...
                         case "rheinland_pfalz":
                            ...
                            var ws4 = parseFloat(data2.rheinland_pfalz[parseInt(index1)+parseInt(21)]["Insgesamt"]).toFixed(2); 
                            var ws5 = parseFloat(data2.rheinland_pfalz[parseInt(index1)+parseInt(28)]["Insgesamt"]).toFixed(2);
                            var ws6 = parseFloat(data2.rheinland_pfalz[parseInt(index1)+parseInt(35)]["Insgesamt"]).toFixed(2);
                            var ws7 = parseFloat(data2.rheinland_pfalz[parseInt(index1)+parseInt(42)]["Insgesamt"]).toFixed(2); 
                            var ws8 = parseFloat(data2.rheinland_pfalz[parseInt(index1)+parseInt(49)]["Insgesamt"]).toFixed(2); 
                            var ws9 = parseFloat(data2.rheinland_pfalz[parseInt(index1)+parseInt(56)]["Insgesamt"]).toFixed(2); 
                            var ws10 = parseFloat(data2.rheinland_pfalz[parseInt(index1)+parseInt(63)]["Insgesamt"]).toFixed(2); 
                            var ws11 = parseFloat(data2.rheinland_pfalz[parseInt(index1)+parseInt(70)]["Insgesamt"]).toFixed(2); 
                            var ws12 = parseFloat(data2.rheinland_pfalz[parseInt(index1)+parseInt(77)]["Insgesamt"]).toFixed(2); 
                            var ws13 = parseFloat(data2.rheinland_pfalz[parseInt(index1)+parseInt(84)]["Insgesamt"]).toFixed(2); 
                            var ws14 = parseFloat(data2.rheinland_pfalz[parseInt(index1)+parseInt(91)]["Insgesamt"]).toFixed(2); 
                            var ws15 = parseFloat(data2.rheinland_pfalz[parseInt(index1)+parseInt(98)]["Insgesamt"]).toFixed(2); 
                            var ws16 = parseFloat(data2.rheinland_pfalz[parseInt(index1)+parseInt(105)]["Insgesamt"]).toFixed(2);
                                // Daten der LineChart werden aktualisiert: Umrechnung in Prozent und in den 2. Datensatz geladen 
                                myLineChart.datasets[1].points[0].value = parseFloat(((ws1 * 100) / a)).toFixed(2);
                                myLineChart.datasets[1].points[1].value = parseFloat(((ws2 * 100) / b)).toFixed(2);
                                myLineChart.datasets[1].points[2].value = parseFloat(((ws3 * 100) / c)).toFixed(2);
                         ...
                         case "saarland":
                            ...
                            var ws4 = parseFloat(data2.saarland[parseInt(index1)+parseInt(21)]["Insgesamt"]).toFixed(2); 
                            var ws5 = parseFloat(data2.saarland[parseInt(index1)+parseInt(28)]["Insgesamt"]).toFixed(2);
                            var ws6 = parseFloat(data2.saarland[parseInt(index1)+parseInt(35)]["Insgesamt"]).toFixed(2);
                            var ws7 = parseFloat(data2.saarland[parseInt(index1)+parseInt(42)]["Insgesamt"]).toFixed(2); 
                            var ws8 = parseFloat(data2.saarland[parseInt(index1)+parseInt(49)]["Insgesamt"]).toFixed(2); 
                            var ws9 = parseFloat(data2.saarland[parseInt(index1)+parseInt(56)]["Insgesamt"]).toFixed(2); 
                            var ws10 = parseFloat(data2.saarland[parseInt(index1)+parseInt(63)]["Insgesamt"]).toFixed(2); 
                            var ws11 = parseFloat(data2.saarland[parseInt(index1)+parseInt(70)]["Insgesamt"]).toFixed(2); 
                            var ws12 = parseFloat(data2.saarland[parseInt(index1)+parseInt(77)]["Insgesamt"]).toFixed(2); 
                            var ws13 = parseFloat(data2.saarland[parseInt(index1)+parseInt(84)]["Insgesamt"]).toFixed(2); 
                            var ws14 = parseFloat(data2.saarland[parseInt(index1)+parseInt(91)]["Insgesamt"]).toFixed(2); 
                            var ws15 = parseFloat(data2.saarland[parseInt(index1)+parseInt(98)]["Insgesamt"]).toFixed(2); 
                            var ws16 = parseFloat(data2.saarland[parseInt(index1)+parseInt(105)]["Insgesamt"]).toFixed(2);
                                // Daten der LineChart werden aktualisiert: Umrechnung in Prozent und in den 2. Datensatz geladen 
                                myLineChart.datasets[1].points[0].value = parseFloat(((ws1 * 100) / a)).toFixed(2);
                                myLineChart.datasets[1].points[1].value = parseFloat(((ws2 * 100) / b)).toFixed(2);
                                myLineChart.datasets[1].points[2].value = parseFloat(((ws3 * 100) / c)).toFixed(2);
                         ...
                         case "sachsen_anhalt":
                            ...
                            var ws4 = parseFloat(data2.sachsen_anhalt[parseInt(index1)+parseInt(21)]["Insgesamt"]).toFixed(2); 
                            var ws5 = parseFloat(data2.sachsen_anhalt[parseInt(index1)+parseInt(28)]["Insgesamt"]).toFixed(2);
                            var ws6 = parseFloat(data2.sachsen_anhalt[parseInt(index1)+parseInt(35)]["Insgesamt"]).toFixed(2);
                            var ws7 = parseFloat(data2.sachsen_anhalt[parseInt(index1)+parseInt(42)]["Insgesamt"]).toFixed(2); 
                            var ws8 = parseFloat(data2.sachsen_anhalt[parseInt(index1)+parseInt(49)]["Insgesamt"]).toFixed(2); 
                            var ws9 = parseFloat(data2.sachsen_anhalt[parseInt(index1)+parseInt(56)]["Insgesamt"]).toFixed(2); 
                            var ws10 = parseFloat(data2.sachsen_anhalt[parseInt(index1)+parseInt(63)]["Insgesamt"]).toFixed(2); 
                            var ws11 = parseFloat(data2.sachsen_anhalt[parseInt(index1)+parseInt(70)]["Insgesamt"]).toFixed(2); 
                            var ws12 = parseFloat(data2.sachsen_anhalt[parseInt(index1)+parseInt(77)]["Insgesamt"]).toFixed(2); 
                            var ws13 = parseFloat(data2.sachsen_anhalt[parseInt(index1)+parseInt(84)]["Insgesamt"]).toFixed(2); 
                            var ws14 = parseFloat(data2.sachsen_anhalt[parseInt(index1)+parseInt(91)]["Insgesamt"]).toFixed(2); 
                            var ws15 = parseFloat(data2.sachsen_anhalt[parseInt(index1)+parseInt(98)]["Insgesamt"]).toFixed(2); 
                            var ws16 = parseFloat(data2.sachsen_anhalt[parseInt(index1)+parseInt(105)]["Insgesamt"]).toFixed(2);
                                // Daten der LineChart werden aktualisiert: Umrechnung in Prozent und in den 2. Datensatz geladen 
                                myLineChart.datasets[1].points[0].value = parseFloat(((ws1 * 100) / a)).toFixed(2);
                                myLineChart.datasets[1].points[1].value = parseFloat(((ws2 * 100) / b)).toFixed(2);
                                myLineChart.datasets[1].points[2].value = parseFloat(((ws3 * 100) / c)).toFixed(2);
                         ...
                         case "schleswig_holstein":
                            ...
                            var ws4 = parseFloat(data2.schleswig_holstein[parseInt(index1)+parseInt(21)]["Insgesamt"]).toFixed(2); 
                            var ws5 = parseFloat(data2.schleswig_holstein[parseInt(index1)+parseInt(28)]["Insgesamt"]).toFixed(2);
                            var ws6 = parseFloat(data2.schleswig_holstein[parseInt(index1)+parseInt(35)]["Insgesamt"]).toFixed(2);
                            var ws7 = parseFloat(data2.schleswig_holstein[parseInt(index1)+parseInt(42)]["Insgesamt"]).toFixed(2); 
                            var ws8 = parseFloat(data2.schleswig_holstein[parseInt(index1)+parseInt(49)]["Insgesamt"]).toFixed(2); 
                            var ws9 = parseFloat(data2.schleswig_holstein[parseInt(index1)+parseInt(56)]["Insgesamt"]).toFixed(2); 
                            var ws10 = parseFloat(data2.schleswig_holstein[parseInt(index1)+parseInt(63)]["Insgesamt"]).toFixed(2); 
                            var ws11 = parseFloat(data2.schleswig_holstein[parseInt(index1)+parseInt(70)]["Insgesamt"]).toFixed(2); 
                            var ws12 = parseFloat(data2.schleswig_holstein[parseInt(index1)+parseInt(77)]["Insgesamt"]).toFixed(2); 
                            var ws13 = parseFloat(data2.schleswig_holstein[parseInt(index1)+parseInt(84)]["Insgesamt"]).toFixed(2); 
                            var ws14 = parseFloat(data2.schleswig_holstein[parseInt(index1)+parseInt(91)]["Insgesamt"]).toFixed(2); 
                            var ws15 = parseFloat(data2.schleswig_holstein[parseInt(index1)+parseInt(98)]["Insgesamt"]).toFixed(2); 
                            var ws16 = parseFloat(data2.schleswig_holstein[parseInt(index1)+parseInt(105)]["Insgesamt"]).toFixed(2);
                                // Daten der LineChart werden aktualisiert: Umrechnung in Prozent und in den 2. Datensatz geladen 
                                myLineChart.datasets[1].points[0].value = parseFloat(((ws1 * 100) / a)).toFixed(2);
                                myLineChart.datasets[1].points[1].value = parseFloat(((ws2 * 100) / b)).toFixed(2);
                                myLineChart.datasets[1].points[2].value = parseFloat(((ws3 * 100) / c)).toFixed(2);
                         ...
                         case "thuringen":
                            ...
                            var ws4 = parseFloat(data2.thuringen[parseInt(index1)+parseInt(21)]["Insgesamt"]).toFixed(2); 
                            var ws5 = parseFloat(data2.thuringen[parseInt(index1)+parseInt(28)]["Insgesamt"]).toFixed(2);
                            var ws6 = parseFloat(data2.thuringen[parseInt(index1)+parseInt(35)]["Insgesamt"]).toFixed(2);
                            var ws7 = parseFloat(data2.thuringen[parseInt(index1)+parseInt(42)]["Insgesamt"]).toFixed(2); 
                            var ws8 = parseFloat(data2.thuringen[parseInt(index1)+parseInt(49)]["Insgesamt"]).toFixed(2); 
                            var ws9 = parseFloat(data2.thuringen[parseInt(index1)+parseInt(56)]["Insgesamt"]).toFixed(2); 
                            var ws10 = parseFloat(data2.thuringen[parseInt(index1)+parseInt(63)]["Insgesamt"]).toFixed(2); 
                            var ws11 = parseFloat(data2.thuringen[parseInt(index1)+parseInt(70)]["Insgesamt"]).toFixed(2); 
                            var ws12 = parseFloat(data2.thuringen[parseInt(index1)+parseInt(77)]["Insgesamt"]).toFixed(2); 
                            var ws13 = parseFloat(data2.thuringen[parseInt(index1)+parseInt(84)]["Insgesamt"]).toFixed(2); 
                            var ws14 = parseFloat(data2.thuringen[parseInt(index1)+parseInt(91)]["Insgesamt"]).toFixed(2); 
                            var ws15 = parseFloat(data2.thuringen[parseInt(index1)+parseInt(98)]["Insgesamt"]).toFixed(2); 
                            var ws16 = parseFloat(data2.thuringen[parseInt(index1)+parseInt(105)]["Insgesamt"]).toFixed(2);
                                // Daten der LineChart werden aktualisiert: Umrechnung in Prozent und in den 2. Datensatz geladen 
                                myLineChart.datasets[1].points[0].value = parseFloat(((ws1 * 100) / a)).toFixed(2);
                                myLineChart.datasets[1].points[1].value = parseFloat(((ws2 * 100) / b)).toFixed(2);
                                myLineChart.datasets[1].points[2].value = parseFloat(((ws3 * 100) / c)).toFixed(2);
                         ...
                         case "sachsen":
                            ...
                            var ws4 = parseFloat(data2.sachsen[parseInt(index1)+parseInt(21)]["Insgesamt"]).toFixed(2); 
                            var ws5 = parseFloat(data2.sachsen[parseInt(index1)+parseInt(28)]["Insgesamt"]).toFixed(2);
                            var ws6 = parseFloat(data2.sachsen[parseInt(index1)+parseInt(35)]["Insgesamt"]).toFixed(2);
                            var ws7 = parseFloat(data2.sachsen[parseInt(index1)+parseInt(42)]["Insgesamt"]).toFixed(2); 
                            var ws8 = parseFloat(data2.sachsen[parseInt(index1)+parseInt(49)]["Insgesamt"]).toFixed(2); 
                            var ws9 = parseFloat(data2.sachsen[parseInt(index1)+parseInt(56)]["Insgesamt"]).toFixed(2); 
                            var ws10 = parseFloat(data2.sachsen[parseInt(index1)+parseInt(63)]["Insgesamt"]).toFixed(2); 
                            var ws11 = parseFloat(data2.sachsen[parseInt(index1)+parseInt(70)]["Insgesamt"]).toFixed(2); 
                            var ws12 = parseFloat(data2.sachsen[parseInt(index1)+parseInt(77)]["Insgesamt"]).toFixed(2); 
                            var ws13 = parseFloat(data2.sachsen[parseInt(index1)+parseInt(84)]["Insgesamt"]).toFixed(2); 
                            var ws14 = parseFloat(data2.sachsen[parseInt(index1)+parseInt(91)]["Insgesamt"]).toFixed(2); 
                            var ws15 = parseFloat(data2.sachsen[parseInt(index1)+parseInt(98)]["Insgesamt"]).toFixed(2); 
                            var ws16 = parseFloat(data2.sachsen[parseInt(index1)+parseInt(105)]["Insgesamt"]).toFixed(2);
                                // Daten der LineChart werden aktualisiert: Umrechnung in Prozent und in den 2. Datensatz geladen 
                                myLineChart.datasets[1].points[0].value = parseFloat(((ws1 * 100) / a)).toFixed(2);
                                myLineChart.datasets[1].points[1].value = parseFloat(((ws2 * 100) / b)).toFixed(2);
                                myLineChart.datasets[1].points[2].value = parseFloat(((ws3 * 100) / c)).toFixed(2);
                 ...
                 $.getJSON("../JSON/studienanfanger_bundeslander.json", function(data1){
                    ...
                    case "thuringen":
                     ...
                     // Initialisierung der Variablen und Verwendung vom Index neu
                        ...
                        var erste = parseFloat(data0.bayern[index1]["Insgesamt"]);
                         var zweite = parseFloat(data0.bayern[parseInt(index1)+parseInt(7)]["Insgesamt"]);
                         var dritte = parseFloat(data0.bayern[parseInt(index1)+parseInt(14)]["Insgesamt"]);
                         var vierte = parseFloat(data0.bayern[parseInt(index1)+parseInt(21)]["Insgesamt"]);
                         var funfte = parseFloat(data0.bayern[parseInt(index1)+parseInt(28)]["Insgesamt"]);
                         var sechste = parseFloat(data0.bayern[parseInt(index1)+parseInt(35)]["Insgesamt"]);
                         var siebte = parseFloat(data0.bayern[parseInt(index1)+parseInt(42)]["Insgesamt"]);
                         var achte = parseFloat(data0.bayern[parseInt(index1)+parseInt(49)]["Insgesamt"]);
                         var neunte = parseFloat(data0.bayern[parseInt(index1)+parseInt(56)]["Insgesamt"]);
                         var zehnte = parseFloat(data0.bayern[parseInt(index1)+parseInt(63)]["Insgesamt"]);
                         var elfte = parseFloat(data0.bayern[parseInt(index1)+parseInt(70)]["Insgesamt"]);
                         var zwolfte = parseFloat(data0.bayern[parseInt(index1)+parseInt(77)]["Insgesamt"]);
                         var dreizehnte = parseFloat(data0.bayern[parseInt(index1)+parseInt(84)]["Insgesamt"]);
                         var vierzehnte = parseFloat(data0.bayern[parseInt(index1)+parseInt(91)]["Insgesamt"]);
                         var funfzehnte = parseFloat(data0.bayern[parseInt(index1)+parseInt(98)]["Insgesamt"]);
                         var sechzehnte = parseFloat(data0.bayern[parseInt(index1)+parseInt(105)]["Insgesamt"]);
                 ...
                 $.getJSON("../JSON/studienanfanger_bundeslander.json", function(data1){
                    ...
                    case "thuringen":
                     ...
                     // Initialisierung der Variablen und Verwendung vom Index neu
                        ...
                        var erste = parseFloat(data0.berlin[index1]["Insgesamt"]);
                         var zweite = parseFloat(data0.berlin[parseInt(index1)+parseInt(7)]["Insgesamt"]);
                         var dritte = parseFloat(data0.berlin[parseInt(index1)+parseInt(14)]["Insgesamt"]);
                         var vierte = parseFloat(data0.berlin[parseInt(index1)+parseInt(21)]["Insgesamt"]);
                         var funfte = parseFloat(data0.berlin[parseInt(index1)+parseInt(28)]["Insgesamt"]);
                         var sechste = parseFloat(data0.berlin[parseInt(index1)+parseInt(35)]["Insgesamt"]);
                         var siebte = parseFloat(data0.berlin[parseInt(index1)+parseInt(42)]["Insgesamt"]);
                         var achte = parseFloat(data0.berlin[parseInt(index1)+parseInt(49)]["Insgesamt"]);
                         var neunte = parseFloat(data0.berlin[parseInt(index1)+parseInt(56)]["Insgesamt"]);
                         var zehnte = parseFloat(data0.berlin[parseInt(index1)+parseInt(63)]["Insgesamt"]);
                         var elfte = parseFloat(data0.berlin[parseInt(index1)+parseInt(70)]["Insgesamt"]);
                         var zwolfte = parseFloat(data0.berlin[parseInt(index1)+parseInt(77)]["Insgesamt"]);
                         var dreizehnte = parseFloat(data0.berlin[parseInt(index1)+parseInt(84)]["Insgesamt"]);
                         var vierzehnte = parseFloat(data0.berlin[parseInt(index1)+parseInt(91)]["Insgesamt"]);
                         var funfzehnte = parseFloat(data0.berlin[parseInt(index1)+parseInt(98)]["Insgesamt"]);
                         var sechzehnte = parseFloat(data0.berlin[parseInt(index1)+parseInt(105)]["Insgesamt"]);
                 ...
                 $.getJSON("../JSON/studienanfanger_bundeslander.json", function(data1){
                    ...
                    case "thuringen":
                     ...
                     // Initialisierung der Variablen und Verwendung vom Index neu
                        ...
                        var erste = parseFloat(data0.brandenburg[index1]["Insgesamt"]);
                         var zweite = parseFloat(data0.brandenburg[parseInt(index1)+parseInt(7)]["Insgesamt"]);
                         var dritte = parseFloat(data0.brandenburg[parseInt(index1)+parseInt(14)]["Insgesamt"]);
                         var vierte = parseFloat(data0.brandenburg[parseInt(index1)+parseInt(21)]["Insgesamt"]);
                         var funfte = parseFloat(data0.brandenburg[parseInt(index1)+parseInt(28)]["Insgesamt"]);
                         var sechste = parseFloat(data0.brandenburg[parseInt(index1)+parseInt(35)]["Insgesamt"]);
                         var siebte = parseFloat(data0.brandenburg[parseInt(index1)+parseInt(42)]["Insgesamt"]);
                         var achte = parseFloat(data0.brandenburg[parseInt(index1)+parseInt(49)]["Insgesamt"]);
                         var neunte = parseFloat(data0.brandenburg[parseInt(index1)+parseInt(56)]["Insgesamt"]);
                         var zehnte = parseFloat(data0.brandenburg[parseInt(index1)+parseInt(63)]["Insgesamt"]);
                         var elfte = parseFloat(data0.brandenburg[parseInt(index1)+parseInt(70)]["Insgesamt"]);
                         var zwolfte = parseFloat(data0.brandenburg[parseInt(index1)+parseInt(77)]["Insgesamt"]);
                         var dreizehnte = parseFloat(data0.brandenburg[parseInt(index1)+parseInt(84)]["Insgesamt"]);
                         var vierzehnte = parseFloat(data0.brandenburg[parseInt(index1)+parseInt(91)]["Insgesamt"]);
                         var funfzehnte = parseFloat(data0.brandenburg[parseInt(index1)+parseInt(98)]["Insgesamt"]);
                         var sechzehnte = parseFloat(data0.brandenburg[parseInt(index1)+parseInt(105)]["Insgesamt"]);
        ...
        case "bremen":
                 ...
                 $.getJSON("../JSON/studienanfanger_bundeslander.json", function(data1){
                    ...
                    case "thuringen":
                     ...
                     // Initialisierung der Variablen und Verwendung vom Index neu
                        ...
                        var erste = parseFloat(data0.bremen[index1]["Insgesamt"]);
                         var zweite = parseFloat(data0.bremen[parseInt(index1)+parseInt(7)]["Insgesamt"]);
                         var dritte = parseFloat(data0.bremen[parseInt(index1)+parseInt(14)]["Insgesamt"]);
                         var vierte = parseFloat(data0.bremen[parseInt(index1)+parseInt(21)]["Insgesamt"]);
                         var funfte = parseFloat(data0.bremen[parseInt(index1)+parseInt(28)]["Insgesamt"]);
                         var sechste = parseFloat(data0.bremen[parseInt(index1)+parseInt(35)]["Insgesamt"]);
                         var siebte = parseFloat(data0.bremen[parseInt(index1)+parseInt(42)]["Insgesamt"]);
                         var achte = parseFloat(data0.bremen[parseInt(index1)+parseInt(49)]["Insgesamt"]);
                         var neunte = parseFloat(data0.bremen[parseInt(index1)+parseInt(56)]["Insgesamt"]);
                         var zehnte = parseFloat(data0.bremen[parseInt(index1)+parseInt(63)]["Insgesamt"]);
                         var elfte = parseFloat(data0.bremen[parseInt(index1)+parseInt(70)]["Insgesamt"]);
                         var zwolfte = parseFloat(data0.bremen[parseInt(index1)+parseInt(77)]["Insgesamt"]);
                         var dreizehnte = parseFloat(data0.bremen[parseInt(index1)+parseInt(84)]["Insgesamt"]);
                         var vierzehnte = parseFloat(data0.bremen[parseInt(index1)+parseInt(91)]["Insgesamt"]);
                         var funfzehnte = parseFloat(data0.bremen[parseInt(index1)+parseInt(98)]["Insgesamt"]);
                         var sechzehnte = parseFloat(data0.bremen[parseInt(index1)+parseInt(105)]["Insgesamt"]);
            ...
            break;
                     ...
                     // Initialisierung der Variablen und Verwendung vom Index neu
                        ...
                        var erste = parseFloat(data0.sachsen[index1]["Insgesamt"]);
                         var zweite = parseFloat(data0.sachsen[parseInt(index1)+parseInt(7)]["Insgesamt"]);
                         var dritte = parseFloat(data0.sachsen[parseInt(index1)+parseInt(14)]["Insgesamt"]);
                         var vierte = parseFloat(data0.sachsen[parseInt(index1)+parseInt(21)]["Insgesamt"]);
                         var funfte = parseFloat(data0.sachsen[parseInt(index1)+parseInt(28)]["Insgesamt"]);
                         var sechste = parseFloat(data0.sachsen[parseInt(index1)+parseInt(35)]["Insgesamt"]);
                         var siebte = parseFloat(data0.sachsen[parseInt(index1)+parseInt(42)]["Insgesamt"]);
                         var achte = parseFloat(data0.sachsen[parseInt(index1)+parseInt(49)]["Insgesamt"]);
                         var neunte = parseFloat(data0.sachsen[parseInt(index1)+parseInt(56)]["Insgesamt"]);
                         var zehnte = parseFloat(data0.sachsen[parseInt(index1)+parseInt(63)]["Insgesamt"]);
                         var elfte = parseFloat(data0.sachsen[parseInt(index1)+parseInt(70)]["Insgesamt"]);
                         var zwolfte = parseFloat(data0.sachsen[parseInt(index1)+parseInt(77)]["Insgesamt"]);
                         var dreizehnte = parseFloat(data0.sachsen[parseInt(index1)+parseInt(84)]["Insgesamt"]);
                         var vierzehnte = parseFloat(data0.sachsen[parseInt(index1)+parseInt(91)]["Insgesamt"]);
                         var funfzehnte = parseFloat(data0.sachsen[parseInt(index1)+parseInt(98)]["Insgesamt"]);
                         var sechzehnte = parseFloat(data0.sachsen[parseInt(index1)+parseInt(105)]["Insgesamt"]);
        ...
        case "hamburg":
                var index1 = $('#Stud_LineChart :selected').val();
                     ...
                     // Initialisierung der Variablen und Verwendung vom Index neu
                        ...
                        var erste = parseFloat(data0.hamburg[index1]["Insgesamt"]);
                         var zweite = parseFloat(data0.hamburg[parseInt(index1)+parseInt(7)]["Insgesamt"]);
                         var dritte = parseFloat(data0.hamburg[parseInt(index1)+parseInt(14)]["Insgesamt"]);
                         var vierte = parseFloat(data0.hamburg[parseInt(index1)+parseInt(21)]["Insgesamt"]);
                         var funfte = parseFloat(data0.hamburg[parseInt(index1)+parseInt(28)]["Insgesamt"]);
                         var sechste = parseFloat(data0.hamburg[parseInt(index1)+parseInt(35)]["Insgesamt"]);
                         var siebte = parseFloat(data0.hamburg[parseInt(index1)+parseInt(42)]["Insgesamt"]);
                         var achte = parseFloat(data0.hamburg[parseInt(index1)+parseInt(49)]["Insgesamt"]);
                         var neunte = parseFloat(data0.hamburg[parseInt(index1)+parseInt(56)]["Insgesamt"]);
                         var zehnte = parseFloat(data0.hamburg[parseInt(index1)+parseInt(63)]["Insgesamt"]);
                         var elfte = parseFloat(data0.hamburg[parseInt(index1)+parseInt(70)]["Insgesamt"]);
                         var zwolfte = parseFloat(data0.hamburg[parseInt(index1)+parseInt(77)]["Insgesamt"]);
                         var dreizehnte = parseFloat(data0.hamburg[parseInt(index1)+parseInt(84)]["Insgesamt"]);
                         var vierzehnte = parseFloat(data0.hamburg[parseInt(index1)+parseInt(91)]["Insgesamt"]);
                         var funfzehnte = parseFloat(data0.hamburg[parseInt(index1)+parseInt(98)]["Insgesamt"]);
                         var sechzehnte = parseFloat(data0.hamburg[parseInt(index1)+parseInt(105)]["Insgesamt"]);
